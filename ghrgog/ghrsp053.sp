...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gsp_upd_hmpl_inactivate')
DROP PROCEDURE [dbo].[gsp_upd_hmpl_inactivate]
GO
...
CREATE procedure [dbo].[gsp_upd_hmpl_inactivate]
