...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gsp_upd_hmpl_reactivate')
DROP PROCEDURE [dbo].[gsp_upd_hmpl_reactivate]
GO
...
CREATE procedure [dbo].[gsp_upd_hmpl_reactivate]
