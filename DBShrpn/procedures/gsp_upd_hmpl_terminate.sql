...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gsp_upd_hmpl_terminate')
DROP PROCEDURE [dbo].[gsp_upd_hmpl_terminate]
GO
...
CREATE procedure [dbo].[gsp_upd_hmpl_terminate]
