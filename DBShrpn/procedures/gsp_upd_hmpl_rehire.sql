...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gsp_upd_hmpl_rehire')
DROP PROCEDURE [dbo].[gsp_upd_hmpl_rehire]
GO
...
CREATE procedure [dbo].[gsp_upd_hmpl_rehire]
       (@p_emp_id					char(15),
...
--SYBSQL             raiserror 20001 "Row updated by another user."
		...
		IF @w_trace_sw = 'Y'
			INSERT INTO DBSosxp.dbo.msg SELECT '20001 Row updated by another user.' AS msg_desc
