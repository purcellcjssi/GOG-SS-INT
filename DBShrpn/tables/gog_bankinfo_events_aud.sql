...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gog_bankinfo_events_aud' )
   DROP TABLE [dbo].[gog_bankinfo_events_aud]
GO
...
CREATE TABLE [dbo].[gog_bankinfo_events_aud](
	[event_id_01] [varchar](2) NOT NULL,
