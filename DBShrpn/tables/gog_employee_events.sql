...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gog_employee_events' )
   DROP TABLE [dbo].[gog_employee_events]
GO
...
CREATE TABLE [dbo].[gog_employee_events](
...
CREATE UNIQUE CLUSTERED INDEX [employee_events_idx] ON [dbo].[gog_employee_events]
(
	[event_id_01] ASC,
	[emp_id_01] ASC,
	[eff_date_01] ASC,
