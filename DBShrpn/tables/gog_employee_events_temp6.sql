...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gog_employee_events_temp6' )
   DROP TABLE [dbo].[gog_employee_events_temp6]
GO
...
CREATE TABLE [dbo].[gog_employee_events_temp6](
