...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gog_current_temp2' )
   DROP TABLE [dbo].[gog_current_temp2]
GO
...
CREATE TABLE [dbo].[gog_current_temp2](
...
IF EXISTS (SELECT * FROM DBShrpn.dbo.sysobjects WHERE name = 'gog_current_temp1' )
   DROP TABLE [dbo].[gog_current_temp1]
GO
